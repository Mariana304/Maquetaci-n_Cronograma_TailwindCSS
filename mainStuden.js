...
window.addEventListener('resize', () => {
    const activeAgendaActivity = document.querySelector('.agendaActivity.active');
    if (activeAgendaActivity) {
        const info = activeAgendaActivity.querySelector('.agendaActivity-info');
        info.style.height = 'auto'; // Primero resetea la altura
        const scrollHeight = info.scrollHeight + 'px'; // Obtén la nueva altura
        info.style.height = scrollHeight; // Ajusta la altura al nuevo tamaño de contenido
    }
});
